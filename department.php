...
<html lang="en">
  ...
  <div class="mb-3 my-4">
    ...
    <input type="text" class="form-control" name="DepartmentName" placeholder="Enter Department Name "  aria-describedby="emailHelp">
    
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Department ID</label>
    <input type="text" name="DepartmentID" placeholder="Enter Department ID " class="form-control" >
  </div>
...
?>
  ...
  <div class="mb-3 my-4">
    ...
    <input type="text" class="form-control" name="DesignationTitle" placeholder="Enter Designation Title "  aria-describedby="emailHelp">
    
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Designation ID</label>
    <input type="text" name="DesignationID" placeholder="Enter Designation ID " class="form-control" >
  </div>
  <label for="exampleColorInput" class="form-label "> Pick Color </label>
<input type="color" class="form-control form-control-color justify-content-center " name="PickColor" value="#563d7c" title="Choose your color">
...
?>
  ...
  <div class="mb-3 my-4">
    ...
    <input type="text" class="form-control" name="EmployeeType" placeholder="Enter Employee Type "  aria-describedby="emailHelp">
    
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Employee ID</label>
    <input type="text" name="EmployeeID" placeholder="Enter Employee ID " class="form-control" >
  </div>
