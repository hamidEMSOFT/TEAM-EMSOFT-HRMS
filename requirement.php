...
<select class="form-control" aria-label=".form-select-sm example">
  ...
  <option value="3">150 to 299</option>
  <option value="4">300 to 499</option>
  ...
  <option value="3">Assistant or Office Manager</option>
  <option value="4">Human Resources Generalist</option>
  <option value="5">Owner / CEO </option>
...
<label for="staticEmail" class="  col-form-label"><b>Your typical hiring budget</b></label>
 <select class="form-control" aria-label=".form-select-sm example">
  ...
  <option value="3">I'm not able to spend on hiring</option>
  ...
  <option value="3">Don't have access to company credit card</option>
  <option value="3">Not apporved by expense policy</option>
...
<option value="2">Social Media</option>
  ...
  <option value="6">BillBoard</option>
  
  <option value="6">Mail</option>
  
  <option value="6">Tv</option>
  <option value="6">Search engine (ex: google/yahoo/binf)</option>
  <option value="6">Other</option>
